...
async function main() {
    ...
    if (!allowWrites) {
        console.error("Write tools disabled. Set FIVETRAN_ALLOW_WRITES=true to enable write tools (connector create/update, sync/resync, setup tests, schema/table/column config edits, schema reload/drop/resync).");
    }
